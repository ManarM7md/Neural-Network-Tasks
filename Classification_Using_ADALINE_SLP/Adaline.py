...
class Adaline:
    ...
    def draw(self,x,y):
        ...
        plt.scatter(x[y == 1][names_features[0]], x[y == 1][names_features[1]], color="#85014d", label='Class 0')
        # Scatter plot for class 1 (positive class)
        plt.scatter(x[y == -1][names_features[0]], x[y == -1][names_features[1]],  color='#ef798d', label='Class 1')
