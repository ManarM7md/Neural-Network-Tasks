...
frame1 = Frame(form)
frame1.pack()
frame1["background"]=bg_color
model_features = LabelFrame(frame1, text="Features", font=header_font, fg=text_color)
model_features["background"]=bg_color
model_features.grid(row=0, column=0, padx=10, pady=10)

lb1 = Label(model_features, text="First Feature", font=text_font, fg=text_color,bg=bg_color)
...
lb2 = Label(model_features, text="Second Feature", font=text_font, fg=text_color,bg=bg_color)
...
frame2 = Frame(form)
frame2.pack()
frame2["background"]=bg_color
model_classes = LabelFrame(frame2, text="Classes ", font=header_font, fg=text_color,bg=bg_color)
model_classes.grid(row=1, column=0, pady=10)

lb3 = Label(model_classes, text="First Class", font=text_font, fg=text_color,bg=bg_color)
...
lb4 = Label(model_classes, text="Second Class", font=text_font, fg=text_color,bg=bg_color)
...
frame3 = Frame(form)
frame3.pack()
frame3["background"]=bg_color
model_parameter = LabelFrame(frame3, text="Parameters", font=header_font, fg=text_color,bg=bg_color)
model_parameter.grid(row=2, column=0, pady=10)

lb5 = Label(model_parameter, text="Learning rate", font=text_font, fg=text_color,bg=bg_color)
lb5.grid(row=2, column=0)
learning_rate = Entry(model_parameter, width="26")
learning_rate.grid(row=3, column=0)

lb6 = Label(model_parameter, text="Epochs", font=text_font, fg=text_color,bg=bg_color)
lb6.grid(row=2, column=1)
epochs = Spinbox(model_parameter, from_=0, to="infinity", width="25")
epochs.grid(row=3, column=1)

lb7 = Label(model_parameter, text="MSE", font=text_font, fg=text_color,bg=bg_color)
...
frame4 = Frame(form)
frame4.pack()
frame4["background"]=bg_color
algo = LabelFrame(frame4, text="Algorithm", font=header_font, fg=text_color,bg=bg_color)
...
algo_var = IntVar()
perceptron = Radiobutton(algo, text="Perceptron", font=text_font, variable=algo_var, value=1, fg=text_color,bg=bg_color)
perceptron.grid(row=4, column=0)
adaline = Radiobutton(algo, text="Adaline", font=text_font, variable=algo_var, value=2, fg=text_color,bg=bg_color)
adaline.grid(row=4, column=1)
##b5ceb1
for widget in algo.winfo_children():
    widget.grid_configure(padx=85, pady=0)

btn1 = Button(frame4, command=submit, text="Submit", width="25", height="1", font=text_font, bg="#fce7e5",
              fg=text_color)
